...
| 20    | Mar 16, 2017 | UI demo + Recap on boards             | UI demo at `www.ulo.camera`; configuration mode entered by placing Ulo upside-down; switched production partner from Estelec (France) to **VVDN Technologies** (India); main board PCB photos shown                                                                                                                              |
...
| 34    | Jan 29, 2018 | Shipping, Cost, Setup & Support       | Apps on App Store and Play Store; cost breakdown: €147 avg per unit; support at `support.ulo.camera`; **firmware update recommended on first use**                                                                                                                                                                              |
...
| 41    | May 27, 2019 | News from Ulo + team                  | Final update; cannot afford refunds; new product "Lua" on Indiegogo. The bankruptcy followed two years later, in June 2021                                                                                                                                                                                                                               |
...
| **Customer support**     | `support.ulo.camera`         | ❌ De-registered (NXDOMAIN)                             |
...
| Support site        | `support.ulo.camera`                                  | ❌ De-registered (NXDOMAIN)     |
| Company site        | `mu-design.lu`                                        | ⚠️ Domain now held by a third party — not linked, see [SECURITY.md §3.4](SECURITY.md#34-s4--the-cloud-update-check) |
| UI Demo             | `www.ulo.camera`                                      | ❌ De-registered (NXDOMAIN)     |
